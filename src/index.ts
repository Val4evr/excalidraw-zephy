...
// Lineage: embed.html → embed-v2.html → mcp-app.html → mcp-app-v2.html → mcp-app-v3.html → mcp-app-v4.html → mcp-app-v5.html.
const EMBED_RESOURCE_URI = 'ui://excalidraw-zephy/mcp-app-v5.html';
